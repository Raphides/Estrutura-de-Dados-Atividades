...
int queueElement(linked_t* queue, element_t value)
{
    if (queue->length == 0)
    {
...
int unqueueElement(linked_t* queue)
{
    if (queue->length == 0)
    {
        return 0;
...
int getElement(linked_t* queue, int index, element_t* result)
{
